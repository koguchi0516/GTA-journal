...
Route::get('/deleteAccount/{user_id}','AdminController@deleteAccount');
Route::get('/release/{user_id}','Admin\AdminHomeController@release');
...
//管理者用認証
Route::group(['prefix' => 'admin',], function () { //teachesディレクトリをここで指定しておく
